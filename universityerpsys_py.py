...
Original file is located at
    https://colab.research.google.com/drive/13CdWeF_fOCkHvk-cWMR2gINPwxlsVI5g
"""
...
staff1 = Staff(staff_id=837, name="Dr. Kalyani", position="Professor", email="kalyani@intuniversity.com")
staff2 = Staff(staff_id=924, name="Mr. Sarvesh", position="Assistant Professor", email="sarvesh@intuniversity.com")
...
# Create Students
student1 = Student(student_id=1241, name="Charles Wellington", dob="2003-02-01", email="charles@intstudent.com")
student2 = Student(student_id=1082, name="Tabitha", dob="2005-05-15", email="tabitha.s@intstudent.com")
